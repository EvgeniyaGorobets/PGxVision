...
data.table is used to transform data.frames into data.tables in some plotting 
and gene set analysis functions for faster manipulation and cleaner syntax 
(_buildVolcanoPlot, buildManhattanPlot, queryGene, expandGeneSets, 
computeGeneSetSimilarity_).
