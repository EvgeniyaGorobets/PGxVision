...
```{r image_grobs, fig.show = "hold", out.width = "33%", fig.align = "default", echo=FALSE}
...
![](./inst/extdata/figures/app-1.png){width=250px}
![](./inst/extdata/figures/app-2.png){width=250px}
![](./inst/extdata/figures/app-3.png){width=250px}
